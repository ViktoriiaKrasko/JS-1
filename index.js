...
function isPositiveNumber(num) {
  return num > 0 ? true : false; // Перевіряємо, чи число num більше 0
...
function isEmptyString(str) {
  return str == "" ? true : false; // Перевіряємо, чи рядок str дорівнює пустому рядку ('')
...
function checkDataType(value) {
  typeof value; // Отримуємо тип значення value за допомогою оператора typeof
  console.log(`Значення "${value}" має тип "${typeof value}".`); // Виводимо у консоль повідомлення, яке містить значення value та його тип
  return typeof value; // Повертаємо тип значення value
}
...
function getVariableType(variable) {
  return typeof variable == "number"
    ...
    ? "Це булеве значення"
    : "Це інший тип"; // Отримуємо тип змінної variable за допомогою оператора typeof
